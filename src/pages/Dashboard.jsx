...
import { AlertCircle, Bell, Gavel } from "lucide-react";
...
function Dashboard() {
  ...
  const fetchDisputes = async () => {
    try {
      // Fetch orders with disputes for farmer/supplier
      ...
      // Extract disputes from orders that have open disputes
      const orderDisputes = [];
      for (const order of orders) {
        if (
          ...
          // Create dispute object from order data
          orderDisputes.push({
