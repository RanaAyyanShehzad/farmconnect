                    ...
                    {order.products?.map((product) => (
                      ...
                      >
                        ...
                        <div className="flex-grow">
                          ...
                          <p className="text-sm text-gray-500 mt-1">
                            Price: {formatCurrency(product.productId?.price || 0)} per {product.productId?.unit}
                          </p>
                          ...
                          <p className="text-sm text-gray-500 mt-1">
                            Seller: {product.productId?.upLoadedBy?.uploaderName || "Unknown Seller"}
                          </p>
              ...
              <form onSubmit={submitReview}>
                <div className="mb-4">
                  ...
                  <div className="flex space-x-1">
                    {renderStarRating(reviewForm.rating, true, handleRatingChange)}
                  </div>
                  {reviewForm.rating > 0 && (
                    <p className="text-sm text-gray-500 mt-1">
